...
public class OrigemContaUserType extends ImmutableUserType {
    ...
    public Object nullSafeGet(ResultSet rs,
        ...
        return OrigemConta.fromDescricao(rs.getString(strings[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement ps,
        ...
        ps.setString(i, ((OrigemConta) o).getDescricao());
    }
}
