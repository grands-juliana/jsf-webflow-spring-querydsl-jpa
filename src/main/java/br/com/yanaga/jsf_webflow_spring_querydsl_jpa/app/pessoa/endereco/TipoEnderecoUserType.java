...
public class TipoEnderecoUserType extends ImmutableUserType {
    ...
    public Object nullSafeGet(ResultSet rs,
        ...
        return TipoEndereco.fromDescricao(rs.getString(strings[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement ps,
        ...
        ps.setString(i, ((TipoEndereco) o).getDescricao());
    }
}
