...
public class TipoOperadoraUserType extends ImmutableUserType {
    ...
    public Object nullSafeGet(ResultSet rs,
        ...
        return TipoOperadora.fromDescricao(rs.getString(strings[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement ps,
        ...
        ps.setString(i, ((TipoOperadora) o).getDescricao());
    }
}
