...
public class SituacaoContaUserType extends ImmutableUserType {
    ...
    public Object nullSafeGet(ResultSet rs,
        ...
        return SituacaoConta.fromDescricao(rs.getString(strings[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement ps,
        ...
        ps.setString(i, ((SituacaoConta) o).getDescricao());
    }
}
