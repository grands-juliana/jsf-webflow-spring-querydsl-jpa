...
public class TipoLogradouroUserType extends ImmutableUserType {
    ...
    public Object nullSafeGet(ResultSet rs,
        ...
        return TipoLogradouro.fromDescricao(rs.getString(strings[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement ps,
        ...
        ps.setString(i, ((TipoLogradouro) o).getDescricao());
    }
}
